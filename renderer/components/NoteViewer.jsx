...
// Human-readable labels for STT service ids
          ...
          <div className="flex items-start gap-3 titlebar-no-drag">
            ...
            <div className="flex-1 min-w-0 space-y-2.5">
              ...
              <div className="flex items-center flex-wrap gap-1.5">
                ...
                {notes?._geminiModel && (
                  <span
                    title={`Notes generated by ${notes._geminiModel}`}
                    className="inline-flex items-center gap-1.5 text-[11px] font-semibold text-violet-600 dark:text-violet-400 bg-violet-500/10 border border-violet-500/30 px-2 py-1 rounded-lg"
                  >
                ...
                {notes?._sttService && (
                  <span
                    title={`Transcribed with ${STT_SERVICE_LABELS[notes._sttService] || notes._sttService}`}
                    className="inline-flex items-center gap-1.5 text-[11px] font-semibold text-teal-600 dark:text-teal-400 bg-teal-500/10 border border-teal-500/30 px-2 py-1 rounded-lg"
                  >
                    <Mic size={11} strokeWidth={2} />
                    {STT_SERVICE_LABELS[notes._sttService] || notes._sttService}
                  </span>
                )}
              </div>
            </div>
