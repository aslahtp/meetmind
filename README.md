...
1. Download and install `MeetMind Setup x.y.z.exe` from the latest [GitHub Releases](https://github.com/aslahtp/meetmind/releases).
...
1. Download and extract `meetmind-extension.zip` from [Releases](https://github.com/aslahtp/meetmind/releases).
